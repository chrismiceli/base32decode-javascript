...
test("null or undefined check", function () {
    ...
    throws(function () {
        return Base32Decode(base32EncodedString);
    }, "Base32Decode throws when argument is undefined");
    base32EncodedString = null;
    throws(function () {
        return Base32Decode(base32EncodedString);
    }, "Base32Decode throws when argument is null");
});
...
test("Length check", function () {
    ...
    notThrows(function () {
        return Base32Decode(base32EncodedString);
    }, "Base32Decode shouldn't throw when argument is empty string");
    base32EncodedString = "a";
    throws(function () {
        return Base32Decode(base32EncodedString);
    }, "Base32Decode throws when the argument is not the correct length");
    ...
    notThrows(function () {
        return Base32Decode(base32EncodedString);
    }, "Base32Decode does not throw when the argument is the correct length");
});
...
test("Valid Characters", function () {
    ...
    throws(function () {
        return Base32Decode(base32EncodedString);
    }, "Base32Decode doesn't allow the 0 character");
    base32EncodedString = "11111111";
    throws(function () {
        return Base32Decode(base32EncodedString);
    }, "Base32Decode doesn't allow the 1 character");
    base32EncodedString = "88888888";
    throws(function () {
        return Base32Decode(base32EncodedString);
    }, "Base32Decode doesn't allow the 8 character");
    base32EncodedString = "99999999";
    throws(function () {
        return Base32Decode(base32EncodedString);
    }, "Base32Decode doesn't allow the 9 character");
    base32EncodedString = "2222=222";
    throws(function () {
        return Base32Decode(base32EncodedString);
    }, "Base32Decode doesn't allow the = character except for padding");
    base32EncodedString = "a=======";
    throws(function () {
        return Base32Decode(base32EncodedString);
    }, "Base32Decode doesn't allow incorrect padding");
    base32EncodedString = "abcdefghijklmnopqrstuvwxyz234567aaaaaaaa";
    notThrows(function () {
        return Base32Decode(base32EncodedString);
    }, "Base32Decode shouldn't throw with valid characters");
...
var compareUint8ArrayToString = function (base32DecodedArray, testString) {
    ...
    for (var index = 0; index < base32DecodedArray.length; index++) {
...
var notThrows = function (statement, message) {
    try  {
        statement();
        ok(true, message);
    } catch (exception) {
